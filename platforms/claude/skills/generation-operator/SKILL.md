...
description: Use when preparing, quoting, dry-running, submitting, monitoring, downloading, or resuming image generation jobs through a selected backend.
---

# Generation Operator

Use `roles/generation-operator.md` and the selected file in `adapters/` as source references when available.

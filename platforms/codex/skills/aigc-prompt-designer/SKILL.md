...
description: Use when converting approved visual concepts into AIGC image prompts and prompt packages, while separating prompt prose from model parameters and preserving semantic intent.
---

# AIGC Prompt Designer

Use `roles/aigc-prompt-designer.md` from this package as the source reference when available.
